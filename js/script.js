// Configuración de colores personalizados de Anytime Fitness
tailwind.config = {
    theme: {
        extend: {
            colors: {
...
const entrenadoresDefault = [
    { 
        ...
        clients: [
            { id: "c_t1", name: "JOSE LUIS GIMENEZ", compliance: Array(21).fill(1) },
            { id: "c_t2", name: "MARIA CARMEN RUIZ", compliance: Array(21).fill(1) },
            { id: "c_t3", name: "ANTONIO LOPEZ", compliance: Array(21).fill(1) },
            { id: "c_t4", name: "FRANCISCO JAVIER GARCIA", compliance: Array(21).fill(1) },
            { id: "c_t5", name: "MARIA DOLORES MARTINEZ", compliance: Array(21).fill(1) }
        ]
    },
    { 
        id: "e2", name: "Oscar", role: "Coaching Team", score: 85, lastAudit: "2026-06-13", status: "good", focus: "Seguimiento MyZone y Evolt.",
        clients: [
            { id: "c_o1", name: "JOSE ANTONIO GONZALEZ ARROYO", compliance: Array(21).fill(1) },
            { id: "c_o2", name: "MONTSERRAT AGUILAR", compliance: Array(21).fill(1) },
            { id: "c_o3", name: "SHEILA DE CARMEN", compliance: Array(21).fill(1) },
            { id: "c_o4", name: "ORIOL BACELLS", compliance: Array(21).fill(1) },
            { id: "c_o5", name: "LISANDRO MELENDEZ", compliance: Array(21).fill(1) },
            { id: "c_o6", name: "JORGE MANUEL DOMINGUEZ", compliance: Array(21).fill(1) },
            { id: "c_o7", name: "MIBEL RIBAS", compliance: Array(21).fill(1) },
            { id: "c_o8", name: "YOLANDA FERNANDEZ", compliance: Array(21).fill(1) },
            { id: "c_o9", name: "ANA MARIN MARTIN", compliance: Array(21).fill(1) },
            { id: "c_o10", name: "RAUL VEGA GARCIA", compliance: Array(21).fill(1) },
            { id: "c_o11", name: "XAVI CATALAN", compliance: Array(21).fill(1) },
            { id: "c_o12", name: "SELENE FERRER", compliance: Array(21).fill(1) },
            { id: "c_o13", name: "MONTSERRAT GARRIGA", compliance: Array(21).fill(1) },
            { id: "c_o14", name: "LLUIS GASSO", compliance: Array(21).fill(1) },
            { id: "c_o15", name: "LAURA MASSOT", compliance: Array(21).fill(1) },
            { id: "c_o16", name: "SAMUEL RODRIGUEZ DA SILVA", compliance: Array(21).fill(1) },
            { id: "c_o17", name: "MONTSERRAT RUIZ GRIBAU", compliance: Array(21).fill(1) },
            { id: "c_o18", name: "GUILLERMO VERA", compliance: Array(21).fill(1) },
            { id: "c_o19", name: "EDUARD FALCON", compliance: Array(21).fill(1) },
            { id: "c_o20", name: "SEIDY GARCIA ISISDRO", compliance: Array(21).fill(1) },
            { id: "c_o21", name: "CLAUDIA SOUZA DA SILVA", compliance: Array(21).fill(1) },
            { id: "c_o22", name: "MONICA ESCAÑO VIAN", compliance: Array(21).fill(1) },
            { id: "c_o23", name: "CESAR DAVID SOLORZANO QUIÑE", compliance: Array(21).fill(1) },
            { id: "c_o24", name: "AUDRY DOTEL", compliance: Array(21).fill(1) },
            { id: "c_o25", name: "CRISTINA BATALLER BATALLER", compliance: Array(21).fill(1) },
            { id: "c_o26", name: "ALEX GIL RAFELS", compliance: Array(21).fill(1) },
            { id: "c_o27", name: "YERAY MELLADO GARCIA", compliance: Array(21).fill(1) },
            { id: "c_o28", name: "NATALIA BELEN DIAZ", compliance: Array(21).fill(1) },
            { id: "c_o29", name: "ADOLFO ROSA RUIZ", compliance: Array(21).fill(1) },
            { id: "c_o30", name: "PAOLA ALONZO ALVAREZ", compliance: Array(21).fill(1) },
            { id: "c_o31", name: "CHAYMAE HOUNAINE", compliance: Array(21).fill(1) },
            { id: "c_o32", name: "WISAL KHAN", compliance: Array(21).fill(1) },
            { id: "c_o33", name: "LIZ PAOLA CANDIA", compliance: Array(21).fill(1) }
        ]
    },
    { 
        id: "e4", name: "Anna", role: "Coaching Team", score: 88, lastAudit: "2026-06-13", status: "good", focus: "Mantener seguimiento.",
        clients: [
            { id: "c_a1", name: "LUISA FERNANDA GOMEZ", compliance: Array(21).fill(1) },
            { id: "c_a2", name: "MARIA ISABEL PEREZ", compliance: Array(21).fill(1) },
            { id: "c_a3", name: "JUAN CARLOS RODRIGUEZ", compliance: Array(21).fill(1) }
        ]
    }
];

const auditoriasDefault = [
    { id: "a1", date: "2026-06-13 09:15", coach: "Oscar", client: "JOSE ANTONIO GONZALEZ ARROYO", score: 88, shift: "Revisión Semanal", obs: "Auditoría inicial con métricas reales." }
];

let entrenadores = JSON.parse(localStorage.getItem('af_coaches_v7')) || entrenadoresDefault;
let auditorias = JSON.parse(localStorage.getItem('af_audits_v7')) || auditoriasDefault;
...
let formParamValues = {};
function resetFormParams() { for(let i = 1; i <= 21; i++) formParamValues[`p${i}`] = 1; }
resetFormParams();
        ...
        listContainer.innerHTML += `
            <div class="bg-brandDark/50 border border-brandBorder rounded-xl p-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div class="flex items-center gap-3">
                    <div class="w-10 h-10 rounded-lg bg-brandBorder flex items-center justify-center text-white font-poppins font-bold text-sm">${coach.name.substring(0,2).toUpperCase()}</div>
                    <div>
                        <h4 class="font-poppins font-semibold text-sm text-white">${coach.name}</h4>
                        <p class="text-xs text-brandText">${coach.role} • ${coach.clients.length} Alumnos</p>
                    </div>
                </div>
                <div class="flex items-center gap-4">
                    <div class="text-right"><p class="text-sm font-poppins font-bold text-white">${coach.score}%</p></div>
        ...
        tableBody.innerHTML += `
            <tr class="border-b border-brandBorder/40 hover:bg-brandPanel/30 transition text-xs">
                ...
                <td class="py-4 text-center">
                    <span class="font-bold px-2 py-0.5 rounded-md ${aud.score >= 85 ? 'text-brandLime bg-brandLime/10' : 'text-red-400 bg-red-400/10'}">${aud.score}%</span>
                </td>
        ...
        grid.innerHTML += `
            <div class="bg-brandPanel border border-brandBorder rounded-2xl p-5 space-y-4">
                ...
                <div class="space-y-2">
                    ...
                    <div class="grid grid-cols-1 gap-2 max-h-40 overflow-y-auto pr-2">${clientsHtml}</div>
                </div>
            </div>`;
    });
}
...
function optimizarFeedbackConIA() {
    ...
    setTimeout(() => {
        ...
        finalTexarea.value = `Auditoría AF Sant Adrià (${coachName}): ${rawText}. Parámetros de App y MyZone evaluados satisfactoriamente.`;
    }, 800);
}
...
function procesarNuevaAuditoria(event) {
    ...
    let complianceArray = [];
    for(let i = 1; i <= 21; i++) complianceArray.push(formParamValues[`p${i}`]);
    ...
    localStorage.setItem('af_audits_v7', JSON.stringify(auditorias));
    localStorage.setItem('af_coaches_v7', JSON.stringify(entrenadores));
